...
if __name__ == "__main__":
    ...
    train_x, train_y, train_w = np.zeros((train_sample_num, config.TIME_STEPS, 64)), np.zeros((train_sample_num, 1)), np.zeros((train_sample_num, 1))
    train_sample_step = 0
    ...
    valid_x, valid_y, valid_w = np.zeros((valid_sample_num, config.TIME_STEPS, 64)), np.zeros((valid_sample_num, 1)), np.zeros((valid_sample_num, 1))
    valid_sample_step = 0
