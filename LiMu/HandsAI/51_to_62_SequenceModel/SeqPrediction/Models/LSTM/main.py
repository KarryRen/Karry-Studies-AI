...
if __name__ == "__main__":
    ...
    lstm_scratch.W_xc, lstm_scratch.W_hc = weight_ih_l0[:, hidden_size * 2:hidden_size * 3], weight_hh_l0[:, hidden_size * 2:hidden_size * 3]
    lstm_scratch.b_xc[0], lstm_scratch.b_hc[0] = bias_ih_l0[hidden_size * 2:hidden_size * 3], bias_hh_l0[hidden_size * 2:hidden_size * 3]
    lstm_scratch.W_xo, lstm_scratch.W_ho = weight_ih_l0[:, hidden_size * 3:hidden_size * 4], weight_hh_l0[:, hidden_size * 3:hidden_size * 4]
    lstm_scratch.b_xo[0], lstm_scratch.b_ho[0] = bias_ih_l0[hidden_size * 3:hidden_size * 4], bias_hh_l0[hidden_size * 3:hidden_size * 4]
