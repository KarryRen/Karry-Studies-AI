...
if __name__ == "__main__":
    ...
    input_tensor = torch.randn((512, 5, 16))  # shape=(bs, time_steps, d)
    ...
    for i, seq in enumerate(seq_try):
        lstm_scratch.W_xi, lstm_scratch.W_hi = weight_ih_l0[:, seq[0] - 1, :], weight_hh_l0[:, seq[0] - 1, :]
        lstm_scratch.b_xi[0], lstm_scratch.b_hi[0] = bias_ih_l0[seq[0] - 1], bias_hh_l0[seq[0] - 1]
        lstm_scratch.W_xf, lstm_scratch.W_hf = weight_ih_l0[:, seq[1] - 1, :], weight_hh_l0[:, seq[1] - 1, :]
        lstm_scratch.b_xf[0], lstm_scratch.b_hf[0] = bias_ih_l0[seq[1] - 1], bias_hh_l0[seq[1] - 1,]
        lstm_scratch.W_xc, lstm_scratch.W_hc = weight_ih_l0[:, seq[2] - 1, :], weight_hh_l0[:, seq[2] - 1, :]
        lstm_scratch.b_xc[0], lstm_scratch.b_hc[0] = bias_ih_l0[seq[2] - 1], bias_hh_l0[seq[2] - 1]
        lstm_scratch.W_xo, lstm_scratch.W_ho = weight_ih_l0[:, seq[3] - 1, :], weight_hh_l0[:, seq[3] - 1, :]
        lstm_scratch.b_xo[0], lstm_scratch.b_ho[0] = bias_ih_l0[seq[3] - 1], bias_hh_l0[seq[3] - 1]
